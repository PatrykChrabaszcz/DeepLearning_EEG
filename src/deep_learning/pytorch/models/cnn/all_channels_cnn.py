...
class AllChannelsCNN(Module):
    def __init__(self, in_size, out_size, num_layers, kernel_size, dilation, stride,
        ...
        for i in range(num_layers):
            conv = Conv1d(in_channels=in_size, out_channels=out_size, kernel_size=kernel_size, stride=stride,
