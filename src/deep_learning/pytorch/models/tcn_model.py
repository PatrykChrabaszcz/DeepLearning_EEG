...
class TemporalConvNet(PytorchModelBase):
    ...
    def add_arguments(parser):
        ...
        parser.add_argument("dropout", type=float, default=0.2,
                            help="TODO")
        parser.add_argument("kernel_size", type=float, default=2,
                            help="TODO")
        parser.add_argument("num_channels", type=str, default='20,30,40',
                            help="TODO", )
        return parser
    ...
    def __init__(self, num_channels, kernel_size=2, dropout=0.2, **kwargs):
        ...
        layers = []
        num_channels = [int(c) for c in num_channels.split(',')]
